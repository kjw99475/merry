...
<%--                                <label for="data_title">제목</label>--%>
                                ...
                                <textarea class="mt-3" name="data_content" id="content" ></textarea>

                                <input type="file" name="file" id="file" multiple>

                                <div class="row justify-content-end mt-3">
                                    <div>
                                        <button type="button" class="btn btn-outline-merry" onclick="location.href='/admin/data/list'">취소</button>
