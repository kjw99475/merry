                ...
                <div class="checkout-section mt-80 mb-150">
                    <div style="margin: 0 auto;">
                        ...
                        <div class="row justify-content-end m-3">
                            <input type="button" class="btn orange-outline-btn" onclick="location.href='/admin/data/regist'" value="등록">
                        </div>
                    </div>
                    <div class="container">
                        <div style="margin: 0 auto;">
                                        ...
                                        <c:when test="${!empty responseDTO.dtoList}">
                                            ...
                                            <c:forEach items="${responseDTO.dtoList}" var="bbsDTO" varStatus="loop">
                                                <tr class="table-body-row text-center">
                                                    ...
                                                    <td class="p-2"><a href="/admin/data/view?data_idx=${bbsDTO.data_idx}" class="black-text">${bbsDTO.data_title}</a><c:if test="${bbsDTO.data_org_file_name != null and bbsDTO.data_org_file_name != '' }" > <i class="fas fa-file"></i></c:if> </td>
                                                    <td class="p-2">${bbsDTO.data_reg_date}</td>
                                                </tr>
                                            </c:forEach>
                                        </c:when>
                                        <c:otherwise>
