...
<%--                                <label for="data_title">제목</label>--%>
                                ...
                                <c:if test="${dataDTO.data_org_file_name != null and dataDTO.data_org_file_name != '' }" >
                                    <div class="mt-4">
                                        <label>첨부파일 : </label>
                                        <span><a href="/admin/data/download?data_idx=${dataDTO.data_idx}" target="_blank">${dataDTO.data_org_file_name}</a></span>
                                    </div>
                                </c:if>
                                ...
                                <div class="row justify-content-between mt-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-merry" onclick="location.href='/admin/data/modify?data_idx=${dataDTO.data_idx}'">수정</button>
                                    </div>
                                </div>
                            </form>
                        </div>
