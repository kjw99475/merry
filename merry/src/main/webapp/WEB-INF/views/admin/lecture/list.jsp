        ...
        <div class="container">
            <div class="row" style="display: grid;grid-template-columns: 280px 1fr;">
                <jsp:include page="/WEB-INF/views/common/admin_sidebar.jsp">
                    <jsp:param name="menuGubun" value="lecture"/>
                </jsp:include>
                    ...
                    <div style="margin: 0 auto;">
                        <form role="search" id="frmSearch">
                            <div class="row mx-5 mb-5 justify-content-center">
                                ...
                                <div>
                                    <button type="button" class="btn orange-btn" onclick="searchType()" >검색</button>
                                </div>
                            </div>
                        </form>
                    </div>
                                                    ...
                                                    <td class="p-2">
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                ...
                                                                <button onclick="deleteOK('${lectureDTO.lec_idx}')" class="btn red-btn">삭제</button>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </td>
                                                    <td class="p-2">${fn:substring(lectureDTO.lec_reg_date, 0, 10)}</td>
                                                </tr>
                                            </c:forEach>
                                        </c:when>
                                        <c:otherwise>
