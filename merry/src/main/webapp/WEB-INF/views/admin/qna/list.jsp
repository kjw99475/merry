        ...
        <div class="row" style="display: grid; grid-template-columns: 280px 1fr;">
            ...
            <div class="checkout-section mt-80 mb-150">
                <div style="margin: 0 auto;">
                    <form id="frmSearch" name="frmSearch" method="get" action="/admin/qna/list">
                ...
                <div class="container">
                    <div style="margin: 0 auto;">
                        <div class="col-auto">
                            <form class="cart-table-wrap" action="/admin/qna/list">
                                <table class="cart-table">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <tr class="table-body-row text-center">
                                                <td class="p-2" colspan="5">작성된 1:1문의가 없습니다.</td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
                                    </tbody>
