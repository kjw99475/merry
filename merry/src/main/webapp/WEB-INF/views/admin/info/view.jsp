    ...
    <div class="container">
        <div class="row" style="display: grid; grid-template-columns: 280px 1fr;">
            <jsp:include page="/WEB-INF/views/common/admin_sidebar.jsp">
                <jsp:param name="menuGubun" value="info"/>
            </jsp:include>
                                ...
                                <div class="full-width site-content col-md-12">
                                    <div>
                                            ...
                                            <form id="frm_" name="frm_" method="post" action="/admin/info/delete">
                                                ...
                                                <table class="table no-wrap user-table mb-0 text-lg-start">
                                                    ...
                                                    <tr class="table-light">
                                                        ...
                                                        <td><a href="/admin/info/download?info_idx=${infoDTO.info_idx}" target="_blank">${infoDTO.info_org_file_name}</a></td>
                                                    </tr>
                                                    <tr class="table-light">
                                        ...
                                        <div class="p-3" style="min-height: 20vh; max-height: 30vh; overflow: auto">
                                            ${infoDTO.info_content}
                                        </div>
                                        <div class="row justify-content-end mt-3">
                                            <div>
                                                <button type="button" class="btn black-outline-btn" onclick="location.href='/admin/info/list'">목록</button>

                                                <button type="button" class="btn orange-outline-btn" onclick="location.href='/admin/info/modify?info_idx=${infoDTO.info_idx}'">수정</button>
