        ...
        <div>
            <div class="container">
                ...
                <div class="row justify-content-end m-3">
                    <input type="button" class="btn btn-merry" onclick="location.href='/admin/info/regist'" value="등록">
                </div>
                        ...
                        <c:when test="${!empty responseDTO.dtoList}">
                            ...
                            <c:forEach items="${responseDTO.dtoList}" var="bbsDTO" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="/admin/info/view?info_idx=${bbsDTO.info_idx}" class="black-text">${bbsDTO.info_title}</a><c:if test="${bbsDTO.info_org_file_name != null and bbsDTO.info_org_file_name != '' }" ><i class="fas fa-pen"></i></c:if> </td>
                                    <td>${bbsDTO.info_reg_date}</td>
                                </tr>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
                ...
                <nav class="blog-pagination justify-content-center d-flex">
                    <ul class="pagination">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/admin/info/list${responseDTO.linked_params}&page=${responseDTO.page_block_end-10}" aria-label="Previous">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/admin/info/list${responseDTO.linked_params}&page=${responseDTO.page_block_start+10}" aria-label="Next">
