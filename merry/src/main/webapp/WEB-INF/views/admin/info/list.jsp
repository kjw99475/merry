                ...
                <div class="checkout-section mt-80 mb-150">
                    <div style="margin: 0 auto;">
                        ...
                        <div class="row justify-content-end m-3">
                            <input type="button" class="btn orange-outline-btn" onclick="location.href='/admin/info/regist'" value="등록">
                        </div>
                    </div>
                    <div class="container">
                        <div style="margin: 0 auto;">
                                        ...
                                        <c:when test="${!empty responseDTO.dtoList}">
                                            ...
                                            <c:forEach items="${responseDTO.dtoList}" var="bbsDTO" varStatus="loop">
                                                <tr class="table-body-row text-center">
                                                    ...
                                                    <td class="p-2"><a href="/admin/info/view?info_idx=${bbsDTO.info_idx}" class="black-text">${bbsDTO.info_title}</a><c:if test="${bbsDTO.info_org_file_name != null and bbsDTO.info_org_file_name != '' }" ><i class="fas fa-file"></i></c:if> </td>
                                                    <td class="p-2">${bbsDTO.info_reg_date}</td>
                                                </tr>
                                            </c:forEach>
                                        </c:when>
                                        <c:otherwise>
