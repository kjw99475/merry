...
<head>
    ...
    <title>Teacher >> manage >> list</title>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-9 text-center">
                    <c:choose>
                            ...
                            <div class="row g-4">
                                <c:forEach var="list" items="${lecturelist}">
                                    <div class="single-latest-news col-lg-4">
                                        <a href="/lecture/view?lec_idx=${list.lec_idx}"><div class="latest-news-bg news-bg-1" style="background: url('/resources/uploads/lecture/${list.lec_img}'); background-size: 100% 100%">
                                        </div></a>
                                        <div class="news-text-box">
                                            <h3><a href="/lecture/list?lec_idx=${list.lec_idx}">${list.lec_title}</a></h3>
                        ...
                        <c:otherwise>
                            <div class="pt-100 pb-100">등록한 강의가 없습니다.</div>
                        </c:otherwise>
                    </c:choose>
