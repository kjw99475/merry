        ...
        <div>
            <div class="container">
                <div class="checkout-section mt-80 mb-150">
                    ...
                    <button type="button" class="btn-lg btn-primary mb-2" onclick="location.href='/teacher/grade/regist'">등록</button>
