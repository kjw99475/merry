...
<div class="container pt-100 mb-5">
    ...
    <form action="/lecture/notice/modify" method="post">
        ...
        <button type="reset" class="btn btn-secondary" onclick="location.href='/lecture/notice/view?notice_idx=${noticeDTO.notice_idx}'">취소하고 돌아가기</button>
    </form>
