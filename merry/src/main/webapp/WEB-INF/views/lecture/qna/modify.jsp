...
<div class="container pt-100 mb-5">
    ...
    <form action="/lecture/qna/modify" method="post">
        ...
        <button type="reset" class="btn btn-secondary" onclick="location.href='/lecture/qna/view?qna_idx=${qnaDTO.qna_idx}'">취소하고 돌아가기</button>
    </form>
