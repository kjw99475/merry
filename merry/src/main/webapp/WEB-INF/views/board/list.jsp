        ...
        <div>
            <div class="container mb-5">
                ...
                <div class="row justify-content-end m-3">
                    <input type="button" class="btn btn-merry" onclick="location.href='/board/regist'" value="등록">
                </div>
                        ...
                        <c:when test="${!empty responseDTO.dtoList}">
                            ...
                            <c:forEach items="${responseDTO.dtoList}" var="bbsDTO" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="/board/view?board_idx=${bbsDTO.board_idx}" class="black-text">${bbsDTO.board_title}</a></td>
                ...
                <nav class="blog-pagination justify-content-center d-flex">
                    <ul class="pagination">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/board/list${responseDTO.linked_params}&page=${responseDTO.page_block_end-10}" aria-label="Previous">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/board/list${responseDTO.linked_params}&page=${responseDTO.page_block_start+10}" aria-label="Next">
