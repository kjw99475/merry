...
<%--                    <input type="button" class="btn btn-merry" onclick="location.href='/notice/regist'" value="등록">--%>
                </div>
                        ...
                        <c:when test="${!empty responseDTO.dtoList}">
                            ...
                            <c:forEach items="${responseDTO.dtoList}" var="bbsDTO" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="/notice/view?notice_idx=${bbsDTO.notice_idx}" class="black-text">${bbsDTO.notice_title}</a><c:if test="${bbsDTO.notice_org_file_name != null and bbsDTO.notice_org_file_name != '' }" ><i class="fas fa-file"></i></c:if> </td>
                ...
                <nav class="blog-pagination justify-content-center d-flex">
                    <ul class="pagination">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/notice/list${responseDTO.linked_params}&page=${responseDTO.page_block_end-10}" aria-label="Previous">
                        ...
                        <li class="page-item">
                            ...
                            <a class="page-link" href="/notice/list${responseDTO.linked_params}&page=${responseDTO.page_block_start+10}" aria-label="Next">
