                ...
                <div class="row mt-5">
                    <div class="col-lg-12 mb-5 mb-lg-0">
                        ...
                        <div class="contact-form">
                            <form id="frm_" name="frm_" method="post" action="/notice/delete">
...
<%--                                <label for="notice_title">제목</label>--%>
                                <table class="table no-wrap user-table mb-0 text-lg-start">
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <td>
                                            <div class="overflow-auto" style="max-height: 500px;">${noticeDTO.notice_content}</div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <c:if test="${noticeDTO.notice_org_file_name != null and noticeDTO.notice_org_file_name != '' }" >
                                    <div class="mt-4">
                                        <label>첨부파일 : </label>
                                        <span><a href="/notice/download?notice_idx=${noticeDTO.notice_idx}" target="_blank">${noticeDTO.notice_org_file_name}</a></span>
                                    </div>
                                </c:if>
...
<%--                                    <button type="button" class="btn btn-outline-merry" onclick="delete_();">삭제</button>--%>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-outline-merry" onclick="location.href='/notice/list'">목록</button>
<%--                                        <button type="button" class="btn btn-merry" onclick="location.href='/notice/modify?notice_idx=${noticeDTO.notice_idx}'">수정</button>--%>
                                    </div>
                                </div>
