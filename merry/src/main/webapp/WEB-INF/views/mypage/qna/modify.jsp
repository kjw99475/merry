                            ...
                            <div class="row mt-5">
                                <div class="mb-5 mb-lg-0">
                                    <div class="contact-form">
                                        <form id="frm_" name="frm_" method="post" action="/mypage/qna/modify">
                                            <input type="hidden" name="member_idx" value="${sessionScope.member_idx}">
                                            <input type="hidden" name="qna_idx" value="${qnaDTO.qna_idx}">
                                            <input type="text" class="form-control" name="qna_title" id="qna_title" value="[수정]${qnaDTO.qna_title}" readonly>
                                            <textarea class="mt-3" name="qna_content" id="content">${qnaDTO.qna_content}</textarea>
                                            <div class="row justify-content-end mt-3">
                                                <div>
                                                    <button type="button" class="btn orange-outline-btn" onclick="location.href='/mypage/qna/list'">취소</button>
