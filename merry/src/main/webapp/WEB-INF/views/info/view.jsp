...
<%--                                <label for="info_title">제목</label>--%>
                                ...
                                <c:if test="${infoDTO.info_org_file_name != null and infoDTO.info_org_file_name != '' }" >
                                    <div class="mt-4">
                                        <label>첨부파일 : </label>
                                        <span><a href="/info/download?info_idx=${infoDTO.info_idx}" target="_blank">${infoDTO.info_org_file_name}</a></span>
                                    </div>
                                </c:if>
...
<%--                                    <button type="button" class="btn btn-outline-merry" onclick="delete_();">삭제</button>--%>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-outline-merry" onclick="location.href='/info/list'">목록</button>
<%--                                        <button type="button" class="btn btn-merry" onclick="location.href='/info/modify?info_idx=${infoDTO.info_idx}'">수정</button>--%>
                                    </div>
                                </div>
